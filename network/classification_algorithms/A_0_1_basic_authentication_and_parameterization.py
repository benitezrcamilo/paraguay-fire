# last_update: '2024/10/22', github:'mapbiomas/paraguay-fire', source: 'IPAM', contact: 'contato@mapbiomas.org'
...
country = 'paraguay'  # Set the country from the available options
...
algorithms = f'/content/paraguay-fire/network/classification_algorithms'

exec(open(f'/content/paraguay-fire/utils/google_collab_pdf_show.py').read())
pdf_path = '/content/paraguay-fire/network/entrenamiento_de_monitoreo_de_cicatrices_de_fuego_en_regiones_de_la_red_mapBiomas.pdf'
